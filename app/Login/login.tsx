          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                name="email"
                className="block w-full px-4 py-3 border border-[#e8e8e0] rounded-lg text-[14px] text-[#1a1a18] placeholder-[#c4c4b8] bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent hover:border-[#c8c8c0] transition-colors"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  name="password"
                  className="block w-full px-4 pr-16 py-3 border border-[#e8e8e0] rounded-lg text-[14px] text-[#1a1a18] placeholder-[#c4c4b8] bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent hover:border-[#c8c8c0] transition-colors"
              ...
              {/* Error */}
              {errorMessage && (
                <div className="mt-2 px-3 py-2.5 bg-red-50 border border-red-100 rounded-lg">
            ...
            <button
              ...
              className="w-full py-3 px-4 rounded-lg text-[14px] font-medium text-white bg-[#1a1a18] hover:bg-[#333] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1a1a18] transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
