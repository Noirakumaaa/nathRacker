...
function BusFields({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <Field label="HH ID">
        <TextInput name="hhId" value={data.hhId} onChange={onChange} />
      </Field>
      <Field label="DRN">
        <TextInput name="drn" value={data.drn} onChange={onChange} />
      </Field>
      <Field label="LGU">
        <TextInput name="lgu" value={data.lgu} onChange={onChange} />
      </Field>
      <Field label="Barangay">
        <TextInput name="barangay" value={data.barangay} onChange={onChange} />
      </Field>
      <Field label="Grantee Name">
        <TextInput name="granteeName" value={data.granteeName} onChange={onChange} />
      </Field>
      <Field label="CL">
        <TextInput name="cl" value={data.cl} onChange={onChange} />
      </Field>
      <Field label="Subject of Change">
        <TextInput name="subjectOfChange" value={data.subjectOfChange} onChange={onChange} />
      </Field>
      <Field label="Type of Update">
        <TextInput name="typeOfUpdate" value={data.typeOfUpdate} onChange={onChange} />
      </Field>
      <Field label="Update Info">
        <TextInput name="updateInfo" value={data.updateInfo} onChange={onChange} />
      </Field>
      <Field label="Issue">
        <TextInput name="issue" value={data.issue} onChange={onChange} />
      </Field>
      <Field label="Remarks">
        <SelectInput
          name="remarks"
      ...
      <Field label="Note">
        <TextArea name="note" value={data.note} onChange={onChange} />
      </Field>
    </div>
  )
}
...
function SwdiFields({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <Field label="Grantee">
        <TextInput name="grantee" value={data.grantee} onChange={onChange} />
      </Field>
      <Field label="CL">
        <TextInput name="cl" value={data.cl ?? ""} onChange={onChange} />
      </Field>
      <Field label="SWDI Score">
        <TextInput name="swdiScore" value={data.swdiScore} onChange={onChange} />
      </Field>
      <Field label="SWDI Level">
        <TextInput name="swdiLevel" value={data.swdiLevel} onChange={onChange} />
      </Field>
      <Field label="Issue">
        <TextInput name="issue" value={data.issue ?? ""} onChange={onChange} />
      </Field>
...
function PcnFields({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <Field label="PCN">
        <TextInput name="pcn" value={data.pcn} onChange={onChange} />
      </Field>
      <Field label="LRN">
        <TextInput name="lrn" value={data.lrn} onChange={onChange} />
      </Field>
      <Field label="Subject of Change">
        <TextInput name="subjectOfChange" value={data.subjectOfChange} onChange={onChange} />
      </Field>
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <Field label="ID Number">
        <TextInput name="idNumber" value={data.idNumber} onChange={onChange} />
      </Field>
      <Field label="LGU">
        <TextInput name="lgu" value={data.lgu} onChange={onChange} />
      </Field>
      ...
      <Field label="Facility Name">
        <TextInput name="facilityName" value={data.facilityName} onChange={onChange} />
      </Field>
      <Field label="Form Type">
        <TextInput name="formType" value={data.formType} onChange={onChange} />
      </Field>
      <Field label="Period">
        <TextInput name="period" value={data.period} onChange={onChange} />
      </Field>
      <Field label="Issue">
        <TextInput name="issue" value={data.issue ?? ""} onChange={onChange} />
      </Field>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-(--color-border) shrink-0">
          <div className="flex items-center gap-3">
            <span
              className={`font-mono text-[10px] font-bold px-2 py-1 rounded-md ${typeColors[type]}`}
            >
              {type}
            </span>
            <div>
              <h2
                id="edit-modal-title"
                className="text-[15px] font-semibold tracking-tight text-(--color-ink)"
              >
                Edit Record
              </h2>
        ...
        <form id="edit-form" onSubmit={handleSave} className="overflow-y-auto px-6 py-5 flex-1">
          {fetching || !formData ? (
            ...
            <>
              {type === "BUS" && (
                <BusFields data={formData as BusFormFields} onChange={handleChange} />
              )}
              {type === "SWDI" && (
                <SwdiFields data={formData as SwdiFormFields} onChange={handleChange} />
              )}
              {type === "PCN" && (
                <PcnFields data={formData as LcnFormFields} onChange={handleChange} />
              )}
              {type === "CVS" && (
                <CvsFields data={formData as CvsFormFields} onChange={handleChange} />
              )}
              {type === "MISC" && (
                <MiscFields data={formData as MiscFormFields} onChange={handleChange} />
              )}
            </>
          )}
        </form>
