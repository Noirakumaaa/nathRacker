      ...
      <main className="p-6 bg-(--color-bg) font-sans antialiased">
        <div className="bg-(--color-surface) border border-(--color-border) rounded-xl p-8 max-w-md flex flex-col items-center gap-3 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-(--color-surface) border border-(--color-border) hover:border-(--color-ink) hover:bg-(--color-subtle) text-sm font-semibold text-(--color-ink) rounded-xl transition-all cursor-pointer"
          >
            <ArrowLeft size={16} />
            Back to Staff
          </button>
    ...
    <main className="p-6 bg-(--color-bg) min-h-screen font-sans antialiased">
      <div className="max-w-full mx-auto flex flex-col gap-5">
        ...
        <div>
          ...
          {/* Back */}
          <button type="button" onClick={() => navigate("/operations/staff")}
            className="inline-flex items-center gap-2 px-4 py-2 mb-3 bg-(--color-surface) border border-(--color-border) hover:border-(--color-ink) hover:bg-(--color-subtle) text-sm font-semibold text-(--color-ink) rounded-xl transition-all cursor-pointer">
            <ArrowLeft size={16} />
            Back to Staff
          </button>
