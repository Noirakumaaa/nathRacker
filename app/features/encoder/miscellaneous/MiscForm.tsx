        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3.5">
              ...
              <div>
                <label htmlFor="misc-hh-id" className={labelCls}>
                  HH ID Number <Req />
                </label>
                <input
                  id="misc-hh-id"
              ...
              <div>
                <label htmlFor="misc-grantee-name" className={labelCls}>
                  Grantee Name <Req />
                </label>
                <input
                  id="misc-grantee-name"
                  type="text"
                  className={inputCls}
              ...
              <div>
                <label htmlFor="misc-subject-of-change" className={labelCls}>
                  Subject of Change <Req />
                </label>
                <input
                  id="misc-subject-of-change"
                  type="text"
                  className={inputCls}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3.5">
              <div>
                <label htmlFor="misc-document-type" className={labelCls}>
                  Document Type <Req />
                </label>
                <input
                  id="misc-document-type"
                  type="text"
                  className={inputCls}
              ...
              <div>
                <label htmlFor="misc-remarks" className={labelCls}>
                  REMARKS <Req />
                </label>
                <select id="misc-remarks" className={inputCls} {...register("remarks")}>
              ...
              <div>
                <label htmlFor="misc-cl" className={labelCls}>
              ...
              <div>
                <label htmlFor="misc-drn" className={labelCls}>
                  DRN
                </label>
                <input
                  id="misc-drn"
              ...
              <div>
                <label htmlFor="misc-date" className={labelCls}>
                  Date Accomplished
                </label>
                <input
                  id="misc-date"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3.5">
              <div>
                <label htmlFor="misc-issue" className={labelCls}>
              ...
              <div>
                <label htmlFor="misc-note" className={labelCls}>
                  Note
                </label>
                <textarea
                  id="misc-note"
