...
const EMPTY_FORM: SwdiFormValues = {
  hhId: "", lgu: "", barangay: "", grantee: "",
  swdiScore: "", swdiLevel: "", remarks: "ENCODED",
  issue: "", cl: "", drn: "", note: "", date: today,
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="pb-2 border-b border-(--color-border)">
              <h3 className="text-[11px] font-semibold text-(--color-ink) uppercase tracking-wider">Household Information</h3>
            </div>
            <div className="space-y-3.5">
              ...
              <div>
                <label htmlFor="hhId" className={labelCls}>HH ID <Req /></label>
                <input
                  type="text"
                  id="hhId"
                  className={inputCls}
              ...
              <div>
                <label htmlFor="grantee" className={labelCls}>Grantee <Req /></label>
                <input
                  type="text"
                  id="grantee"
                  className={inputCls}
          ...
          <div className="space-y-4">
            <div className="pb-2 border-b border-(--color-border)">
              <h3 className="text-[11px] font-semibold text-(--color-ink) uppercase tracking-wider">Assessment Details</h3>
            </div>
            <div className="space-y-3.5">
              ...
              <div>
                <label htmlFor="swdiScore" className={labelCls}>SWDI Score <Req /></label>
                <input
                  type="text"
                  id="swdiScore"
              ...
              <div>
                <label htmlFor="date" className={labelCls}>Date <Req /></label>
                <input
                  type="date"
                  id="date"
                  disabled
          ...
          <div className="space-y-4">
            <div className="pb-2 border-b border-(--color-border)">
              <h3 className="text-[11px] font-semibold text-(--color-ink) uppercase tracking-wider">Issues & Actions</h3>
            </div>
            <div className="space-y-3.5">
              ...
              <div>
                ...
                <div className="flex rounded-lg overflow-hidden border border-(--color-border) focus-within:ring-2 focus-within:ring-(--color-ink) focus-within:border-transparent hover:border-(--color-border-hover) transition-colors">
                  ...
                  <input
                    ...
                    onChange={(e) => setValue("drn", "M&E-" + e.target.value)}
                  />
                </div>
              </div>
