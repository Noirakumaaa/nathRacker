...
export default function BarangayTab() {
  ...
  const matchable =
    importRows?.filter((r) => lgus.find((l) => l.name.toUpperCase() === r.lgu)).length ?? 0
    ...
    <div className="px-6 py-6 space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        >
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <label htmlFor="barangay-name" className={labelCls}>
                  Barangay Name <Req />
                </label>
                <input
                  id="barangay-name"
              ...
              <div>
                <label htmlFor="barangay-lgu" className={labelCls}>
                  LGU <Req />
                </label>
                <select
                  id="barangay-lgu"
              ...
              <SubmitRow
                loading={loading}
                submitLabel="Add Barangay"
                onCancel={() => setForm({ name: "", lguId: "" })}
              />
            </div>
          </div>
        </form>
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {importing ? (
                      ...
                      `Import ${matchable} Barangay${matchable !== 1 ? "s" : ""}`
                    )}
                  </button>
                  <button
                    type="button"
        ...
        <div className="bg-(--color-surface) rounded-xl border border-(--color-border) overflow-hidden lg:col-span-2">
          <PanelHeader
            label={isLoading ? "Barangays" : `Barangays (${barangays.length})`}
            legend={false}
          />
