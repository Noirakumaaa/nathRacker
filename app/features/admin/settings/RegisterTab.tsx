...
export default function RegisterTab() {
  ...
  const filteredLgus = (data?.lgu ?? []).filter(
    (l: Lgu) =>
      form.assignedOperationId === "" || l.operationsOfficeNumId === form.assignedOperationId
  )
  ...
  return (
    <div className="px-6 py-6 space-y-5">
      ...
      <div>
        ...
        <h1 className="text-[20px] font-semibold text-(--color-ink) tracking-tight">
          Register Account
        </h1>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <label htmlFor="register-middle-name" className={labelCls}>
                    Middle Name <Opt />
                  </label>
                  <input
                ...
                <div>
                  <label htmlFor="register-phone" className={labelCls}>
                    Phone Number <Req />
                  </label>
                  <input
                    id="register-phone"
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  <label htmlFor="register-gov-username" className={labelCls}>
                    Government Username <Req />
                  </label>
                  <input
                    id="register-gov-username"
                    name="govUsername"
                    value={form.govUsername}
                    onChange={handle}
                    required
                    className={inputCls}
                    placeholder="Gov Username"
                  />
                </div>
                <div>
                ...
                <div>
                  <label htmlFor="register-confirm-password" className={labelCls}>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  <label htmlFor="register-role" className={labelCls}>
                    Role <Req />
                  </label>
                  <select
                    id="register-role"
                ...
                <div>
                  <label htmlFor="register-operation" className={labelCls}>
                ...
                <div>
                  <label htmlFor="register-lgu" className={labelCls}>
                    Assigned LGU <Req />
                  </label>
                  <select
                    id="register-lgu"
                ...
                <div>
                  <label htmlFor="register-barangay" className={labelCls}>
